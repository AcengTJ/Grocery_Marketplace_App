...
<body class="p-0 m-0">
  <nav class="navbar bg-info bg-info bg-gradient navbar-expand-lg">
    <div class="container-fluid col-10">
      ...
      <div class="d-flex">
        <div class="dropdown">
          <a class="btn btn-none btn-outline-light dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
            aria-expanded="false">
            <?= ucwords($_SESSION["row"]["name"]) ?>
          </a>

          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="profile.php?id=<?= $_SESSION["row"]["id"]; ?>"><i class="bi bi-person-circle"></i> Profil</a></li>
            ...
            <li><a class="dropdown-item" href="../controller/logoutController.php"><i class="bi bi-box-arrow-left"></i>
                Log Out</a></li>
          </ul>
        </div>
      </div>
      ...
      <a class="btn btn-card" href="detail.php?id=<?= $product["id"] ?>">
        <div class="card mx-2 shadow-sm bg-body rounded" style="width: 12rem; height:17rem;">
          <div class="text-center">
            <img src="../public/img/product/<?= $product["image"] ?>" class="img-fluid card-img-top p-3"
              style="width: 10rem;">
          </div>
